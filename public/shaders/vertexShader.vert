...
// Periodic Perlin noise function
...
// === Vertex Shader Main ===
void main() {
    // Add noise to the surface over time
    float noise = 2.0 * pnoise(position + vec3(u_time), vec3(4.0));
    float displacement = noise / 6.5;

    // Deform vertex along its normal
